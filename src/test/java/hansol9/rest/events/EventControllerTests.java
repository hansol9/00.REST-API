...
import hansol9.rest.common.RestDocsConfiguration;
        ...
        mockMvc.perform(post("/api/events")
                ...
                .andDo(document("create-event",
                        ...
                        requestFields(
                                ...
                                fieldWithPath("limitOfEnrollment").description("Limit of enrollment for new event")
                        ),
                        responseHeaders(
...
//                .andExpect(jsonPath("$[0].rejectedValue").exists())
    ...
    public void getEvent_404() throws Exception {
        ...
        //when
        ResultActions perform = this.mockMvc.perform(get("/api/events/2000"));
    ...
    public void updateEvent_404() throws Exception {
        ...
        //when
        ResultActions perform = this.mockMvc.perform(put("/api/events/300")
                .contentType(MediaType.APPLICATION_JSON_UTF8)
                .content(this.objectMapper.writeValueAsString(eventDTO)));
